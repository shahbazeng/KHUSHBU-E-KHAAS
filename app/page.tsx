...
<footer className="bg-[#0B0F19] text-gray-400 font-sans text-xs pt-24 pb-12 px-6 md:px-16 border-t border-[#D4AF37]/10 relative z-10 antialiased w-full select-none">
  {/* Core Grid Matrix - Perfectly Aligned 4-Column Layout */}
  <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 border-b border-gray-800 pb-16 mb-10 items-start">
    
    {/* Pillar 1: Brand & Socialite Hub */}
    <div className="space-y-6 flex flex-col justify-start">
      ...
      {/* SOCIAL MEDIA HOVER MATRIX WITH ACCENT COLORS */}
    ...
    {/* Pillar 2: Simple English Navigation Links (ADMIN REMOVED SECURELY) */}
    ...
    {/* Pillar 3: Bespoke Services Information Node */}
    <div className="space-y-4 flex flex-col justify-start">
    ...
    {/* Pillar 4: Flagship Store Address Layout */}
    <div className="space-y-4 flex flex-col justify-start">
  ...
  {/* BOTTOM BASEBAR CONTAINER - PAYMENT AND RIGHTS SYSTEM */}
  <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 text-gray-500 text-[11px] font-medium pt-6 border-t border-gray-800/40">
    ...
    {/* PREMIUM ALIGNED BRAND PAYMENT BADGES */}
